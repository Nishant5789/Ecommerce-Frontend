  ...
  return (
    ...
    <div className='bg-slate-300  sm:max-w-7xl max-w-xl  py-4 md:p-20 rounded-lg shadow-2xl'>
      <div>
        ...
        <p className='text-center text-2xl'>Check Your Order Status <Link to="/order"><span className='border-b-2 border-yellow-400 font-bold hover:text-yellow-300'>UserProfile{'->'}order</span></Link> </p>
      </div>
