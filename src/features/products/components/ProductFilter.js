...
import { fetchBrandAsync, fetchCategoryAsync, fetchProductsAsync, selectBrand, selectCategory } from '../productSlice';
...
const ProductFilter = ({ItemName, currentPage}) => {
    ...
    const handleFilterItems = (e) => {
        ...
        if(checked){
            ...
            dispatch(fetchProductsAsync({_page:currentPage, _limit:getTotalProductsPerPage(), [ItemName]: value}));
        }
        else{
